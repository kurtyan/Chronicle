...
test.describe('Notes', () => {
  ...
  test('Notes page creates and autosaves a note', async ({ page }) => {
    ...
    await page.getByRole('combobox', { name: 'Search notes or enter a # tag', exact: true }).fill(`UiNote-${unique}`)
  ...
  test('Notes page searches body content through the API', async ({ page }) => {
    ...
    await page.getByRole('combobox', { name: 'Search notes or enter a # tag', exact: true }).fill(`NeedleBody-${unique}`)
  ...
  test('archived notes can be shown, searched, opened, and unarchived', async ({ page }) => {
    ...
    await page.getByRole('combobox', { name: 'Search notes or enter a # tag', exact: true }).fill(`ArchiveBody-${unique}`)
