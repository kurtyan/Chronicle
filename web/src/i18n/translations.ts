...
export const translations: Record<string, TranslationEntry> = {
  ...
  'editor.heading3': { 'zh-CN': '标题 3', en: 'Heading 3' },
  'editor.heading4': { 'zh-CN': '标题 4', en: 'Heading 4' },
  'editor.indent': { 'zh-CN': '增加缩进', en: 'Indent' },
  'editor.outdent': { 'zh-CN': '减少缩进', en: 'Outdent' },
  ...
  'afk.timeaway': { 'zh-CN': '离开时长', en: 'Time Away' },
  'afk.reason': { 'zh-CN': '原因', en: 'Reason' },
  'afk.notePlaceholder': { 'zh-CN': '请简要说明离开原因（可选）...', en: 'Briefly describe why you were away (optional)...' },
  'afk.submit': { 'zh-CN': '提交', en: 'Submit' },
  'afk.submitting': { 'zh-CN': '提交中...', en: 'Submitting...' },
  'afk.dismiss': { 'zh-CN': '取消', en: 'Dismiss' },
  ...
  'report.noTasks': { 'zh-CN': '暂无任务', en: 'No tasks' },
