...
export interface ApiInterface {
  ...
  submitDayScriptProgress(date: string, body?: { focusActivity?: DayScriptFocusActivity[]; submitAnchor?: DayScriptSubmitAnchor }): Promise<SubmitDayScriptProgressResult>
